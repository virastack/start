  ...
  return (
    <section className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 pt-24 pb-16 text-center">
      ...
      <motion.p
        ...
        className="max-w-2xl text-base text-muted-foreground sm:text-lg leading-relaxed text-balance"
      >
        Built with{" "}
        ...
        - wired together with <span className="italic font-medium text-foreground">Zustand</span>, <span className="italic font-medium text-foreground">TanStack Query</span>, and <span className="italic font-medium text-foreground">React Hook Form</span> so you can ship a polished product from day one.
      </motion.p>
