  ...
  return (
    <svg viewBox="0 0 180 180" {...props}>
      ...
      <g mask="url(#nextjs_icon_mask)">
        <circle cx="90" cy="90" data-circle="true" fill="currentColor" className="text-black dark:text-white" r="90" />
        <path
      ...
      <defs>
        ...
        >
          ...
          <stop offset="1" stopColor="currentColor" stopOpacity="0" className="text-white dark:text-black" />
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
